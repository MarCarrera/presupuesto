...
namespace Presupuesto.Controllers
{
    ...
    public class TransaccionesController : Controller
    {
        ...
        public async Task<FileResult> ExportarExcelPorAño(int año)
        {
            ...
            var nombreArchivo = $"Manejo Presupuesto - {fechaInicio.ToString("yyy")}.xlsx";
            return GenerarExcel(nombreArchivo, transacciones);
        ...
        //Metodo que muestra las transacciones en el calendario
            ...
            DateTime end)
        {
            ...
            var eventosCalendario = transacciones.Select(transacciones => new EventoCalendario()
            {
                ...
                Start = transacciones.FechaTransaccion.ToString("yyy-MM-dd"),
                End = transacciones.FechaTransaccion.ToString("yyy-MM-dd"),
            ...
            TipoOperacion tipoOperacion)
        {
            ...
            var resultados = categorias.Select(x => new SelectListItem(x.Nombre, x.Id.ToString())).ToList();
            var opcionPorDefecto = new SelectListItem("Selecciones una categoria", "0", true);
            resultados.Insert(0, opcionPorDefecto);
            return resultados;
        }
        [HttpPost]
